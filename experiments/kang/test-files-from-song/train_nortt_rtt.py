...
if __name__ == "__main__":
    ...
    parser.add_argument("--train_path", default="../../../data/train_sampled_Normed.csv", type=str)
    parser.add_argument("--dev_path", default="../../../data/dev_rtt.csv", type=str)
    parser.add_argument("--test_path", default="../../../data/dev_rtt.csv", type=str)
    ...
    wandb_name = (
        f"kyc3492_Normalized_rtt_KcELECTRA"
    )
