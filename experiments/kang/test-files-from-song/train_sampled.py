...
if __name__ == "__main__":
    ...
    parser.add_argument("--train_path", default="../../../data/train_sampled.csv", type=str)
    parser.add_argument("--dev_path", default="../../../data/dev_sampled.csv", type=str)
    parser.add_argument("--test_path", default="../../../data/dev_sampled.csv", type=str)
